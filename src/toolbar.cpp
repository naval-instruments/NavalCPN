...
void ocpnToolBarSimple::OnRightClick( int id, long WXUNUSED(x), long WXUNUSED(y) )
{
    ...
    if(parent){
        if(parent->m_FloatingToolbarConfigMenu){
            ToolbarChoicesDialog *dlg = new ToolbarChoicesDialog(NULL, GetParent(), -1, _T("NavalCPN"), wxDefaultPosition, wxSize(100,100));
...
ToolbarMOBDialog::ToolbarMOBDialog( wxWindow* parent )
       : wxDialog( parent, wxID_ANY, _("NavalCPN Alert"), wxDefaultPosition, wxSize(250, 230) )
{
